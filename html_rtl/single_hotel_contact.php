...
<!-- Mirrored from www.ansonika.com/citytours/html_rtl/single_hotel_contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Mar 2023 05:56:22 GMT -->
                                	...
                                	<div class="row">
										...
										<div class="col-lg-4">
											...
											<ul>
												...
												<li><a href="../index-2.html"><i class="icon-align-left"></i> LTR Version</a></li>      
											</ul>
										</div>
                                    </div><!-- End row -->
                                </div><!-- End menu-wrapper -->
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form method="post" action="http://www.ansonika.com/citytours/html_rtl/assets/review_hotel.php" name="review_hotel" id="review_hotel">
